...
if __name__ == '__main__':
    raw_results: Dict[str,Dict[int,List[float]]] = \
        read_results('./results/results.csv')
    ...
    write_latex_tabular(refined_results['quadratic'], './results/quadratic_table.tex')
    write_latex_tabular(refined_results['hashmap'], './results/hashmap_table.tex')
    
    plot_filename = './results/plot.png'
    plot_algorithms(refined_results, plot_filename)